...
const script = [
  ...
  { sender: "me", message: "It smells like wet soil. That smell we always knew,  when we were growing up, building, making, playing with sand. It’s the kind of smell that settles deep in the chest. It smells. The light here is soft, almost reverent. It doesn’t illuminate so much as it listens. Small figures, black, rounded, sit quietly in the space. It’s the light that shapes them. Or maybe it’s the other way around. I feel heard by the earth. It smells. Everything here is in conversation: earth and sky, shadow and glow, presence and memory. It is a play between light and soil. Between the visible and the felt. I feel the earth has something to tell. This is Cielo Terrenal (Earthly Heaven) by Delcy Morelos. But it feels like a place we’ve already known. A space we entered through the soles of our feet. A reminder that the sacred can be grounded. That we carry the earth inside us. I wish you could stand in this room with me. I think it would speak to you, too." },
];
